                ...
                <table class="table table-borderless" id="dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$vendor->item}}</td>
                            <td><a href="EditVendorPage/{{$vendor->id}}/edit" type="button" class="btn btn-success">edit</a></td>
                            <td><a href="DeleteVendorPage/{{$vendor->id}}/delete" type="button" class="btn btn-danger">delete</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
